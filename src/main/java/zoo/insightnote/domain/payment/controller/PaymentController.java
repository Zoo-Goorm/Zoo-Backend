...
public interface PaymentController {
    @Operation(summary = "결제 요청 API", description = "카카오페이 API에 결제를 요청합니다.")
    @ApiResponse(responseCode = "200", description = "결제 요청 성공", content = @Content(schema = @Schema(implementation = KakaoPayReadyResponseDto.class)))
    @PostMapping("/request")
